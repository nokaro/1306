...
<title>1306에 오신 걸 환영합니다.</title>

<script type="text/javascript">
	function joinMoveFnc(form) {
		form.action = "/1306/member/add.do";
		form.method = "get";
		form.submit();
		return true;
	}   
...
<body>
	<div class="main">
		...
		<form class="form1" action="/1306/loginCtr.do" method="post">
			...
			<p>
				<a href='/1306/member/findidpw.do'>아이디/비밀번호 찾기</a>
		</form>
	</div>  
</body>
